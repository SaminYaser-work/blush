        ...
        <>
            ...
            <Section heading="Latest Posts">
                ...
                <Post
                    ...
                    cardWidth="w-[60rem]"
                    cardHeight="h-[15rem]"
                    picUrl="https://picsum.photos/1440/560"
            ...
            <Section>
                <Banner>
                    <>
                        <svg id="logo-87" className={"mb-2"} width="202" height="40" viewBox="0 0 202 40" fill="none"
                            ...
                            <path className="ccustom" fillRule="evenodd" clipRule="evenodd"
                                  ...
                                  fill="#ffffff" stopColor="#ffffff"></path>
                            <path className="ccustom" fillRule="evenodd" clipRule="evenodd"
                                  ...
                                  fill="#ffffff" stopColor="#ffffff"></path>
                            <path className="ccustom" d="M125.619 14.4525H120.767V29.8648H125.619V14.4525Z"
                                  fill="#ffffff" stopColor="#ffffff"></path>
                            <path className="ccustom"
                                  ...
                                  fill="#ffffff" stopColor="#ffffff"></path>
                            <path className="ccustom"
                                  d="M51.1562 29.8648V7.47568H56.1351V25.4885H66.0612V29.8648H51.1562Z" fill="#ffffff"
                                  stopColor="#ffffff"></path>
                            <path className="ccustom" fillRule="evenodd" clipRule="evenodd"
                        ...
                        <p className="text-5xl text-white font-['Vidaloka'] max-w-md whitespace-nowrap leading-[1.2]">
            ...
            <Section>
                <Banner>
                    <p className="text-5xl text-white font-['Vidaloka'] max-w-md leading-[1.2]">
                        Best Gutenberg
                        <br/>
                        Post Grid Plugin
                    </p>
                        ...
                        .map((_, i) => (
                            <div key={i}>
                                <Post
                                    ...
                                    reverse={i % 2 == 0}
                                />
                                <hr className={"w-full border-t-[3px] border-dashed my-16 border-slate-500"}/>
                            </div>
                        ))}
                    <Button text={"Load More"} className={"px-8 py-3 text-xl"}/>
                </div>
            </Section>

            <Section heading="Instagram Feeds">
                    ...
                    {Array(4)
                        ...
                        .map((_, i) => (
                            <img
                                ...
                                src={"https://picsum.photos/1440/560"}
                                alt="insta_post"
                            />
                        ))}
                </div>
                <Button text={"Follow Us"} className={"w-full py-3 text-xl"}/>
            </Section>

            <Section fullWidth className={"my-32 mb-0"}>
                <CallToAction/>
            </Section>
